!function( $ ) {
	...
	$.fn.orders.defaults = {
		dataTables: {
			aoColumnDefs: [
				{ bSortable: false, aTargets: [ 0, 5 ] }, // First column and last column ("actions") are not sortable
				{ bVisible: false, aTargets: [ 0 ] }, // Hide the first column
				{ sClass: "actions", aTargets: [ 5 ] } // Set special "actions" class on cells in the last column
			],
			asStripeClasses: [],
			bAutoWidth: false,
			bPaginate: true,
